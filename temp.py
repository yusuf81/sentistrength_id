...
csvFile = open('twitterhash.csv', 'a')
#Use csv Writer
csvWriter = csv.writer(csvFile)

#for tweet in tweepy.Cursor(api.search,q="#RevitalisasiPasar",count=1000,
#                           lang="id",
#                           since="2017-01-01", mode="extended").items():
#    print (tweet.created_at, tweet.fulltext)
...
results=api.search(q="Lion Air",count=1000,lang="id",since="2017-01-01", tweet_mode="extended")
for tweet in results:
    print (tweet.created_at, tweet.full_text, senti.main(tweet.full_text.encode('utf-8')))
    csvWriter.writerow([tweet.created_at, tweet.full_text.encode('utf-8'), senti.main(tweet.full_text.encode('utf-8'))])
